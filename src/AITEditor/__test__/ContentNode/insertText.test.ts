...
let testData = [
	{
		...
		expectedHTML:
			'<div class="AITE__editor" data-aite_editor_root="true" contenteditable="true" spellcheck="false" style="font-size: 16px;"><div data-aite_block_node="true"><span data-aite-node="true">Testing text for editor</span></div></div>',
		caseSelection: {
			anchorOffset: 0,
			focusOffset: 0,
			anchorPath: [0],
